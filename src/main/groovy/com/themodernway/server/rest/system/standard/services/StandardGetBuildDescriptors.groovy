...
@RequestBinding('/system/standard/services/build/descriptors')
public class StandardGetBuildDescriptors extends RESTServiceSupport
{
    @Override
    ...
    @Memoized
    public JSONObject getDescriptors()
    {
