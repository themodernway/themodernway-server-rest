...
@RequestBinding('/system/standard/services')
public class StandardGetSystemServices extends RESTServiceSupport
{
    @Override
    ...
    @Memoized
    public JSONObject getSystemServices()
    {
        def list = []
        
        getServices().each { service ->
